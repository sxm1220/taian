...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">号牌区域:</label>
			<div class="controls">
				<form:input path="hp" htmlEscape="false" maxlength="2"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group"> 
			<label class="control-label">打印字体大小：</label>
			<div class="controls">
				<form:select path="fontSize" >
					<form:option value="" label="--请选择--"/>
					<form:options items="${fns:getDictList('font_size')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
