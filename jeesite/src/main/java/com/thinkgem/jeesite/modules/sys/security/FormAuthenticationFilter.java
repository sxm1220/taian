...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
	...
	protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
		...
		String softdog = getSoftDog(request);
		return new UsernamePasswordToken(username, password.toCharArray(), rememberMe, host, captcha, mobile,softdog);
	}
	
	private String getSoftDog(ServletRequest request) {
		// TODO Auto-generated method stub
		return WebUtils.getCleanParam(request, getSoftDogParam());
	}

	private String getSoftDogParam() {
		// TODO Auto-generated method stub
		return "softdog";
	}
