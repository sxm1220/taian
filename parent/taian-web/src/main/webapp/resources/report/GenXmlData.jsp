<%@ page contentType="text/html; charset=utf-8" import="com.nova.his.core.utils.DataSourceUtil"%>
...
{
    XML_GenDetailData(response, QuerySQL, DefaultReportDataType);
}
...
{
    XML_GenParameterData(response, QuerySQL, DefaultReportDataType);
}
...
{
    XML_GenDetailData(response, QuerySQL, ToCompress? ResponseDataType.ZipBinary:ResponseDataType.PlainText);
}
...
{
    XML_GenParameterData(response, QuerySQL, ResponseDataType.PlainText);
}
